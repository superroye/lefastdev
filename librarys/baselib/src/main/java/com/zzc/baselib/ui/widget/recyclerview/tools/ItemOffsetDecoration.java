package com.zzc.baselib.ui.widget.recyclerview.tools;
...
public class ItemOffsetDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (lm instanceof GridLayoutManager) {
            ...
            reverse = ((LinearLayoutManager) lm).getOrientation() == LinearLayoutManager.HORIZONTAL;
        }
        ...
        // Assume Linear
            ...
            if(reverse){
                isLeft = isTop;
                isRight = adapterCount - adapterPosition <= spanCount;
            }else {
